                  ...
                  {loadingSlots ? (
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                      ...
                      {slots.map((s) => {
                        ...
                        const businessIanaTz = toIana(business.timezone);

                        // 2️⃣ Parse UTC slot start
                        const slotStartUTC = DateTime.fromISO(s.start, {
                          zone: "utc",
                        });

                        // 3️⃣ Convert to business timezone
                        const businessTime =
                          slotStartUTC.setZone(businessIanaTz);

                        // 4️⃣ Convert to user's local timezone
                        const userTime = slotStartUTC.setZone(userTimezone);
